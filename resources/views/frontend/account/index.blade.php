              ...
              <div class="product-menu">
                <ul class="list-inline m-0 nav nav-tabs flex-column bg-transparent border-0" role="tablist">
                  <li class="pb-3 nav-item" role="presentation">
                    <button class="nav-link active p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#dashboard"
                      type="button" role="tab" aria-selected="true"><i class="fas fa-tachometer-alt"></i><span
                        class="ms-2">Dashboard</span></button>
                  </li>
                  <li class="py-3 nav-item" role="presentation">
                    <button class="nav-link p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#orders"
                      type="button" role="tab" aria-selected="false" tabindex="-1"><i class="fas fa-list"></i><span
                        class="ms-2">Orders</span></button>
                  </li>
                  <li class="py-3 nav-item" role="presentation">
                    <button class="nav-link p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#downloads"
                      type="button" role="tab" aria-selected="false" tabindex="-1"><i class="fas fa-download"></i><span
                        class="ms-2">Downloads</span></button>
                  </li>
                  <li class="py-3 nav-item" role="presentation">
                    <button class="nav-link p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#address"
                      type="button" role="tab" aria-selected="false" tabindex="-1"><i
                        class="fas fa-map-marker-alt"></i><span class="ms-2">Address</span></button>
                  </li>
                  <li class="py-3 nav-item" role="presentation">
                    <button class="nav-link p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#account-details"
                      type="button" role="tab" aria-selected="false" tabindex="-1"><i class="fas fa-user"></i><span
                        class="ms-2">Account details</span></button>
                  </li>
                  <li class="pt-3 nav-item" role="presentation">
                    <button class="nav-link p-0 bg-transparent" data-bs-toggle="tab" data-bs-target="#logout"
                      type="button" role="tab" aria-selected="false" tabindex="-1"><i
                    ...
                    <div class="text-body mb-4">
                      <form>
                        ...
                        <div class="form-group mb-5">
                          ...
                          <div class="mb-5">
                            <select class="select2-basic-single js-states form-control select2-hidden-accessible"
                              aria-label="select country" required="required" data-select2-id="select2-data-1-d6tk"
                              tabindex="-1" aria-hidden="true">
                              <option value="" selected="" data-select2-id="select2-data-3-8iua">Choose a country
                              </option>
                            ...
                            </select><span class="select2 select2-container select2-container--default wide" dir="ltr"
                              data-select2-id="select2-data-2-45vb" style="width: 100%;"><span class="selection"><span
                                  class="select2-selection select2-selection--single" role="combobox"
                                  aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false"
                                  aria-labelledby="select2-wfsv-container" aria-controls="select2-wfsv-container"><span
                                    class="select2-selection__rendered" id="select2-wfsv-container" role="textbox"
                                    aria-readonly="true" title="Choose a country">Choose a country</span><span
                        ...
                        <div class="form-group mb-5">
                          ...
                          <div class="mb-5">
                            <select class="select2-basic-single js-states form-control select2-hidden-accessible"
                              aria-label="select state" data-select2-id="select2-data-4-88ry" tabindex="-1"
                              aria-hidden="true">
                              <option value="" selected="" data-select2-id="select2-data-6-11cn">Choose a State</option>
                              ...
                              data-select2-id="select2-data-5-mfbv" style="width: 100%;"><span class="selection"><span
                                  class="select2-selection select2-selection--single" role="combobox"
                                  aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false"
                                  aria-labelledby="select2-vvd8-container" aria-controls="select2-vvd8-container"><span
                                    class="select2-selection__rendered" id="select2-vvd8-container" role="textbox"
                                    aria-readonly="true" title="Choose a State">Choose a State</span><span
                                    class="select2-selection__arrow" role="presentation"><b
                                      role="presentation"></b></span></span></span><span class="dropdown-wrapper"
                                aria-hidden="true"></span></span>
                          </div>
                    ...
                    <div class="text-body mb-4">
                      <form>
                        ...
                        <div class="form-group mb-5">
                          <label class="mb-2">Country / Region &nbsp; <span class="text-danger">*</span></label>
                          <div class="mb-5">
                            <select class="select2-basic-single js-states select2-hidden-accessible"
                              aria-label="select country" required="required" data-select2-id="select2-data-7-c4fi"
                              tabindex="-1" aria-hidden="true">
                              <option value="" selected="" data-select2-id="select2-data-9-tvvc">Choose a country
                              </option>
                              <option value="1">India</option>
                              <option value="2">United Kingdom</option>
                              <option value="3">United States</option>
                              ...
                              data-select2-id="select2-data-8-3uut" style="width: 100%;"><span class="selection"><span
                                  class="select2-selection select2-selection--single" role="combobox"
                                  aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false"
                                  aria-labelledby="select2-u44g-container" aria-controls="select2-u44g-container"><span
                                    class="select2-selection__rendered" id="select2-u44g-container" role="textbox"
                                    aria-readonly="true" title="Choose a country">Choose a country</span><span
                                    class="select2-selection__arrow" role="presentation"><b
                                      role="presentation"></b></span></span></span><span class="dropdown-wrapper"
                                aria-hidden="true"></span></span>
                        ...
                        <div class="form-group mb-5">
                          ...
                          <div class="mb-5">
                            <select class="select2-basic-single js-states select2-hidden-accessible"
                              aria-label="select state" data-select2-id="select2-data-10-qxvo" tabindex="-1"
                              aria-hidden="true">
                              <option value="" selected="" data-select2-id="select2-data-12-xaqo">Choose a State
                              </option>
                              <option value="1">Gujarat</option>
                              <option value="2">Delhi</option>
                              <option value="3">Goa</option>
                              ...
                              data-select2-id="select2-data-11-29a1" style="width: 100%;"><span class="selection"><span
                                  class="select2-selection select2-selection--single" role="combobox"
                                  aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false"
                                  aria-labelledby="select2-tfpo-container" aria-controls="select2-tfpo-container"><span
                                    class="select2-selection__rendered" id="select2-tfpo-container" role="textbox"
                                    aria-readonly="true" title="Choose a State">Choose a State</span><span
                                    class="select2-selection__arrow" role="presentation"><b
                                      role="presentation"></b></span></span></span><span class="dropdown-wrapper"
                                aria-hidden="true"></span></span>
                    ...
                    <div class="col-md-6">
                      ...
                      <form method="post">
                        ...
                        <p class="mb-5"> Your personal data will be used to support your experience
                          ...
                          our <a href="https://templates.iqonic.design/streamit-dist/frontend/html/privacy-policy.html">
                            privacy policy</a>.
                        </p>
                        <div class="iq-button">
                          <a href="javascript:void(0)" class="btn text-uppercase position-relative">
