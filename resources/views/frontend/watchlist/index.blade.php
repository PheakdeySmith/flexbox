        ...
        <div class="profile-box">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                ...
                <div class="account-logo d-flex align-items-center position-relative">
                    <img src="{{ asset('frontend/assets') }}/images/profile.webp" class="img-fluid object-cover rounded-3" alt="profile" />
        ...
        <div class="tabs">
            ...
            <div class="content-details iq-custom-tab-style-two">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/playlist.html#playlist" role="tab"
                    aria-selected="false" tabindex="-1">Playlist</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" data-bs-toggle="pill"
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/playlist.html#watchlist" role="tab"
                    aria-selected="false" tabindex="-1">Watchlist</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" data-bs-toggle="pill"
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/playlist.html#favorites" role="tab"
                ...
                <div id="playlist" class="tab-pane animated fadeInUp" role="tabpanel">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                        ...
                        <div class="watchlist-warpper card-hover-style-two">
                            ...
                            <div class="card-description">
                                ...
                                <a href="https://templates.iqonic.design/streamit-dist/frontend/html/playlist.html">Play
                                    List 1</a>
                                </h5>
                                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="text-center">
                        <div class="iq-button">
                        <button type="button" class="btn text-uppercase position-relativ" data-bs-toggle="modal"
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                ...
                <small class="d-block my-2">Support *.webp, *webp, *.gif, *.webp. Maximun upload file
                  size: 5mb.</small>
                <input type="file" class="form-control" />
              </div>
              <div class="form-group d-flex align-items-center gap-3">
                <button class="btn btn-sm btn-light text-uppercase fw-medium">
                  cancel
                </button>
                <button class="btn btn-sm btn-primary text-uppercase fw-medium">
                  save
                </button>
              </div>
            </form>
