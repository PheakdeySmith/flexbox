        ...
        <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="trailor-video col-md-3 col-12 mt-lg-0 mt-4 mb-md-0 mb-1 text-lg-right">
                <a data-fslightbox="html5-video" href="https://www.youtube.com/watch?v=QCGq1epI9pQ"
                  ...
                  <img src="{{ asset('frontend/assets') }}/images/01.webp" class="attachment-medium-large size-medium-large wp-post-image"
                    alt="" loading="lazy">
          ...
          <div class="content-details trending-info">
            <ul
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="pill"
                  href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html#source-01"
                  role="tab" aria-selected="false" tabindex="-1">
                  Sources
                </a>
              </li>
