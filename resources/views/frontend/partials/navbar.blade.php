          ...
          <div class="d-flex gap-3 gap-xl-0 align-items-center">
            ...
            <div class="logo-default">
              <a class="navbar-brand text-primary"
                ...
                <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo.webp" loading="lazy" alt="streamit">
              </a>
            </div>
            <div class="logo-hotstar">
              <a class="navbar-brand text-primary"
                href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-hotstar.webp" loading="lazy" alt="streamit">
              </a>
            </div>
            <div class="logo-prime">
              <a class="navbar-brand text-primary"
                href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-prime.webp" loading="lazy" alt="streamit">
              </a>
            </div>
            <div class="logo-hulu">
              <a class="navbar-brand text-primary"
                href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-hulu.webp" loading="lazy" alt="streamit">
              </a>
            </div>
              ...
              <div class="offcanvas-header px-0">
                <div class="navbar-brand ms-3">
                  ...
                  <div class="logo-hotstar">
                    <a class="navbar-brand text-primary"
                      href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                      <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-hotstar.webp" loading="lazy"
                        alt="streamit">
                    </a>
                  </div>
                  <div class="logo-prime">
                    <a class="navbar-brand text-primary"
                      href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                      <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-prime.webp" loading="lazy"
                        alt="streamit">
                    </a>
                  </div>
                  <div class="logo-hulu">
                    <a class="navbar-brand text-primary"
                      href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html">
                      <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo-hulu.webp" loading="lazy"
                        alt="streamit">
                    </a>
                  </div>
                </div>
              ...
              <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                  ...
                  <ul class="sub-nav mega-menu-item collapse justify-content-center list-unstyled" id="homePages">
                    <li class="nav-item">
                      <a class="nav-link p-0 active"
                        href="{{ route('frontend.home') }}">
                        <img src="{{ asset('frontend/assets') }}/images/new-home.webp" alt="img" class="img-fluid d-xl-block d-none">
                    ...
                    <li class="nav-item">
                      <a class="nav-link p-0 "
                        ...
                        <img src="{{ asset('frontend/assets') }}/images/movie.webp" alt="img" class="img-fluid d-xl-block d-none">
                        <span class="d-inline-block ">Movie</span>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link p-0 "
                        href="{{ route('frontend.tvSerie') }}">
                        <img src="{{ asset('frontend/assets') }}/images/tv-show.webp" alt="img" class="img-fluid d-xl-block d-none">
                ...
                <li class="nav-item">
                  ...
                  <ul class="sub-nav collapse  list-unstyled" id="features">
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.restrictDetail') }}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.genre') }}"> Geners </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.actor') }}"> Cast </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link "
                        href="https://templates.iqonic.design/streamit-dist/frontend/html/tags.html"> Tags </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse"
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html#pages" role="button"
                  ...
                  <ul class="sub-nav collapse  list-unstyled" id="pages">
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.subscription') }}"> Subscription </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link "
                          href="{{ route('frontend.404') }}"> Error Page </a>
                      </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse"
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html#shop" role="button"
                  ...
                  <ul class="sub-nav collapse  list-unstyled" id="shop">
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.account') }}"> My
                        Account Page </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.cart') }}"> Cart Page
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link "
                    ...
                    <li class="nav-item">
                      <a class="nav-link "
                        href="{{ route('frontend.orderDetail') }}">
                        Order Tracking </a>
                    </li>
                  </ul>
                </li>
              ...
              <ul class="navbar-nav align-items-center ms-auto mb-2 mb-xl-0">
                ...
                <li class="nav-item dropdown" id="itemdropdown1">
                  <a class="nav-link d-flex align-items-center"
                    href="https://templates.iqonic.design/streamit-dist/frontend/html/index.html#" id="navbarDropdown"
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                    ...
                    <li class="user-info d-flex align-items-center gap-3 mb-3">
                      <img src="{{ asset('frontend/assets') }}/images/user1.webp" class="img-fluid" alt="" loading="lazy">
