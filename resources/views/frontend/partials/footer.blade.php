<footer class="bg-footer1">
    <div class="container-xxxl">
        <div class="row py-3">
            <div class="col-12 col-md-6"><svg width="140" height="40" viewBox="0 0 138 40">
                    <title>Fmovies</title>
                ...
                <p class="py-2"><a class="text-primary" href="https://ww4.fmovies.co/24/">Fmovies</a> -
                    Free movies online, here you can watch movies online
                    in high quality for free without annoying of
                    advertising, just come and enjoy your movies online.
                    fmovie, fmovies, bmovies</p><small class="font-italic small">Disclaimer: This site does
                    not store any files on its server. All contents are
                    provided by non-affiliated third
                    parties.</small>
            </div>
            <div class="col-12 col-md-6">
                <div class="row">
                    <div class="col">
                        <p class="text-uppercase text-white mb-1">Movies</p>
                        <ul class="list-unstyled">
                            <li><a href="https://ww4.fmovies.co/genre/science-fiction/"
                                    title="Science Fiction">Science
                                    Fiction</a></li>
                            <li><a href="https://ww4.fmovies.co/genre/thriller/" title="Thriller">Thriller</a></li>
                            <li><a href="https://ww4.fmovies.co/genre/comedy/" title="Comedy">Comedy</a></li>
                            <li><a href="https://ww4.fmovies.co/genre/horror/" title="Horror">Horror</a></li>
                            <li><a href="https://ww4.fmovies.co/genre/crime/" title="Crime">Crime</a></li>
                        </ul>
                    </div>
                    <div class="col">
                        <p class="text-uppercase text-white mb-1">Country</p>
                        <ul class="list-unstyled">
                            <li><a href="https://ww4.fmovies.co/country/australia/" title="Australia">Australia</a>
                            </li>
                            <li><a href="https://ww4.fmovies.co/country/united-states/" title="United States">United
                                    States</a></li>
                            <li><a href="https://ww4.fmovies.co/country/italy/" title="Italy">Italy</a></li>
                            <li><a href="https://ww4.fmovies.co/country/switzerland/"
                                    title="Switzerland">Switzerland</a></li>
                            <li><a href="https://ww4.fmovies.co/country/united-kingdom/"
                                    title="United Kingdom">United
                                    Kingdom</a></li>
                        </ul>
                    </div>
                    <div class="col">
                        <p class="text-uppercase text-white mb-1">Free
                            movies</p>
                        <ul class="list-unstyled">
                            <li><a href="https://ww4.fmovies.co/movies/" title="Movies">Movies</a></li>
                            <li><a href="https://ww4.fmovies.co/tv-series/" title="Movies">TV-Series</a></li>
                            <li><a href="https://ww4.fmovies.co/top-imdb/" title="Movies">Top
                                    IMDb</a></li>
                        </ul>
                    </div>
                    <div class="col">
                        <p class="text-uppercase text-white mb-1">Help</p>
                        <ul class="list-unstyled">
                            <li><a href="https://ww4.fmovies.co/faqs/" title="FAQ&#39;s">FAQ's</a></li>
                            <li><a href="https://ww4.fmovies.co/dmca/" title="DMCA">DMCA</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-footer2 text-center py-3">Copyright © 2025
        Fmovies.to.
        All Rights
        Reserved</div>
</footer>