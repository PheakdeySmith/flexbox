...
<div style="margin-top: 100px;">
    <section class="banner-container mt-5">
      <div class="movie-banner">
        <div class="swiper swiper-banner-container swiper-initialized swiper-horizontal swiper-pointer-events"
          data-swiper="banner-detail-slider">
          <div class="swiper-wrapper" id="swiper-wrapper-52a0fd3ab839af2f" aria-live="polite"
            style="cursor: grab; transition-duration: 0ms; transform: translate3d(-2405.08px, 0px, 0px);">
            <div class="swiper-slide movie-banner-2 p-0 swiper-slide-duplicate swiper-slide-duplicate-next"
              data-swiper-slide-index="1" style="width: 1265.83px;" role="group" aria-label="2 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-2.webp" alt="movie-banner-image">
              </div>
                  ...
                  <div class="col-lg-7 col-md-12">
                    ...
                    <div class="flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                      ...
                      <p class="movie-banner-text line-count-3" data-animation-in="fadeInUp" data-delay-in="1.2">
                        ...
                        the most contiguous empire of the world i.e. the Mongol empire.He made an army by himself by
                        uniting some
            ...
            <div class="swiper-slide movie-banner-3 p-0 swiper-slide-duplicate swiper-slide-prev"
              data-swiper-slide-index="2" style="width: 1265.83px;" role="group" aria-label="3 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-3.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
                <div class="row align-items-center h-100">
                  <div class="col-lg-7 col-md-12">
                    ...
                    <div class="flex-wrap align-items-center fadeInLeft animated" data-animation-in="fadeInLeft"
                      ...
                      <p class="movie-banner-text line-count-3" data-animation-in="fadeInUp" data-delay-in="1.2">
                        ...
                        was a 19th-century male African bush elephant born in Sudan. Jumbo was exported to Jardin des
                        Plantes, a zoo in
                        Paris, and then transferred in 1865 to London Zoo in England. Despite public protest, Jumbo was
                        sold to P. T.
            ...
            <div class="swiper-slide movie-banner-1 p-0 swiper-slide-active" data-swiper-slide-index="0"
              style="width: 1265.83px;" role="group" aria-label="1 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-1.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
                <div class="row align-items-center h-100">
                  <div class="col-lg-7 col-md-12">
            ...
            <div class="swiper-slide movie-banner-2 p-0 swiper-slide-next" data-swiper-slide-index="1"
              style="width: 1265.83px;" role="group" aria-label="2 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-2.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
            ...
            <div class="swiper-slide movie-banner-3 p-0 swiper-slide-duplicate-prev" data-swiper-slide-index="2"
              style="width: 1265.83px;" role="group" aria-label="3 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-3.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
            ...
            <div class="swiper-slide movie-banner-1 p-0 swiper-slide-duplicate swiper-slide-duplicate-active"
              data-swiper-slide-index="0" style="width: 1265.83px;" role="group" aria-label="1 / 3">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-1.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
            ...
            <div class="swiper-slide movie-banner-2 p-0 swiper-slide-duplicate swiper-slide-duplicate-next"
              data-swiper-slide-index="1" role="group" aria-label="2 / 3" style="width: 1265.83px;">
              <div class="movie-banner-image">
                <img src="{{ asset('frontend/assets') }}/images/movie-banner-2.webp" alt="movie-banner-image">
              </div>
              <div class="shows-content h-100">
          ...
          <div class="swiper-banner-button-next" tabindex="0" role="button" aria-label="Next slide"
            aria-controls="swiper-wrapper-52a0fd3ab839af2f">
            <i class="iconly-Arrow-Right-2 icli arrow-icon"></i>
          </div>
          <div class="swiper-banner-button-prev" tabindex="0" role="button" aria-label="Previous slide"
            aria-controls="swiper-wrapper-52a0fd3ab839af2f">
        ...
        <div class="overflow-hidden">
          ...
          <div class="card-style-slider">
            <div class="position-relative swiper swiper-card swiper-initialized swiper-horizontal swiper-pointer-events"
              data-slide="6" data-laptop="5" data-tab="3" data-mobile="2" data-mobile-sm="2" data-autoplay="false"
              ...
              <ul class="p-0 swiper-wrapper m-0  list-inline"
                ...
                id="swiper-wrapper-9cc2bd318e220cd1" aria-live="polite">
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1"
                  style="width: 219.833px;" role="group" aria-label="2 / 7">
                        ...
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">Batte
                                Wiire</a>
                            </h5>
                          ...
                          <li class="share position-relative d-flex align-items-center text-center mb-0">
                            ...
                            <div class="share-wrapper">
                              <div class="share-boxs d-inline-block">
                                ...
                                <div class=" overflow-hidden">
                                  <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie.html"
                                    target="_blank">
                ...
                <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" style="width: 219.833px;"
                ...
                <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" style="width: 219.833px;"
                ...
                <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" style="width: 219.833px;"
                ...
                <li class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="5" style="width: 219.833px;"
                    ...
                    <div class="block-images position-relative w-100">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">oit
                                moleld</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                ...
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="6"
                  style="width: 219.833px;" role="group" aria-label="7 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                        <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html"
                ...
                <li class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" style="width: 219.833px;"
                ...
                <li class="swiper-slide swiper-active" data-swiper-slide-index="2" style="width: 219.833px;"
                  role="group" aria-label="3 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                ...
                <li class="swiper-slide swiper-active" data-swiper-slide-index="3" style="width: 219.833px;"
                  role="group" aria-label="4 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                ...
                <li class="swiper-slide swiper-active" data-swiper-slide-index="4" style="width: 219.833px;"
                  role="group" aria-label="5 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                ...
                <li class="swiper-slide swiper-active last" data-swiper-slide-index="5" style="width: 219.833px;"
                  role="group" aria-label="6 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                ...
                <li class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="6"
                  style="width: 219.833px;" role="group" aria-label="7 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                ...
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                  data-swiper-slide-index="0" style="width: 219.833px;" role="group" aria-label="1 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      <div class="img-box w-100">
                        <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html"
              ...
              <div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                aria-controls="swiper-wrapper-9cc2bd318e220cd1"></div>
        ...
        <div class="overflow-hidden">
          ...
          <div class="card-style-slider">
            <div class="position-relative swiper swiper-card swiper-initialized swiper-horizontal swiper-pointer-events"
              ...
              <ul class="p-0 swiper-wrapper m-0  list-inline"
                style="transform: translate3d(-1319px, 0px, 0px); transition-duration: 0ms;"
                id="swiper-wrapper-c9d37337a7b91e01" aria-live="polite">
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1"
                  style="width: 219.833px;" role="group" aria-label="2 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a
                                href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">advetre</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                              <span class="movie-time-text font-normal">1hr : 30mins</span>
                            </div>
                    ...
                    <div class="block-images position-relative w-100">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">net
                                ailo</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a
                                href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">ariivaal</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a
                                href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">dramma</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a
                                href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">aune</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a
                                href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">everest</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
                    ...
                    <div class="block-images position-relative w-100">
                      ...
                      <div class="card-description with-transition">
                        <div class="cart-content">
                          <div class="content-left">
                            <h5 class="iq-title text-capitalize">
                              <a href="https://templates.iqonic.design/streamit-dist/frontend/html/movie-detail.html">mortal
                                nories</a>
                            </h5>
                            <div class="movie-time d-flex align-items-center my-2">
              ...
              <div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                aria-controls="swiper-wrapper-c9d37337a7b91e01"></div>
              <div class="swiper-button swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide"
                aria-controls="swiper-wrapper-c9d37337a7b91e01"></div>
              <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
        ...
        <section class="overflow-hidden">
          ...
          <div class="card-style-slider">
            <div class="position-relative swiper swiper-card swiper-initialized swiper-horizontal swiper-pointer-events"
              ...
              <ul class="p-0 swiper-wrapper m-0  list-inline"
                style="transform: translate3d(-1319px, 0px, 0px); transition-duration: 0ms;"
                id="swiper-wrapper-722958ef859685de" aria-live="polite">
                <li class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1"
                  style="width: 219.833px;" role="group" aria-label="2 / 7">
                  <div class="iq-card card-hover">
                    <div class="block-images position-relative w-100">
              ...
              <div class="swiper-button swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
                aria-controls="swiper-wrapper-722958ef859685de"></div>
              <div class="swiper-button swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide"
                aria-controls="swiper-wrapper-722958ef859685de"></div>
              <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
            </div>
