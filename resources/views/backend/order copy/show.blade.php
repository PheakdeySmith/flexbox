                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Price</th>
                                                        <td><span
                                                                class="badge badge-info">${{ number_format($order->price, 2) }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Status</th>
                                            ...
                                            <div class="card-body">
                                                @if ($order->user)
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="mr-3">
                                                            <img src="{{ Storage::url($order->user->user_profile) }}"
                                                                alt="{{ $order->user->name }}" class="img-circle"
                                                                width="80" height="80">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <th>Total Orders</th>
                                                            <td>{{ App\Models\OrderItem::where('user_id', $order->user->id)->count() }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <div class="mt-3">
                                                ...
                                                @else
                                                    <div class="alert alert-warning">
                                                        <i class="fas fa-exclamation-triangle mr-2"></i> User information
                                                        not available
                                                    </div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                @if ($order->movie->release_date)
                                                                    <span class="badge badge-secondary mr-2">
                                                                        ...
                                                                        {{ $order->movie->release_date->format('Y') }}
                                                                    </span>
                                                                @endif
                                                                @if ($order->movie->runtime)
                                                                    <span class="badge badge-secondary mr-2">
                                                                        <i class="far fa-clock mr-1"></i>
                                                                        {{ $order->movie->runtime }} min
                                                                    </span>
                                                                @endif
                                                                @if ($order->movie->price)
                                                                    <span class="badge badge-success">
                                                                        <i class="fas fa-tag mr-1"></i>
                                                                        ${{ number_format($order->movie->price, 2) }}
                                                                    </span>
                                                                @endif
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                @if ($order->movie->genres)
                                                                    @foreach ($order->movie->genres as $genre)
                                                                        <span
                                                                            class="badge badge-info mr-1">{{ $genre->name }}</span>
                                                                    @endforeach
                                                                @endif
                                                            </div>

                                                            <h5>Overview</h5>
                                                            <p>{{ $order->movie->overview ?? 'No overview available.' }}
                                                            </p>

                                                            <div class="mt-4">
                                                                <a href="{{ route('movie.show', $order->movie->id) }}"
                                                                    class="btn btn-primary">
                                                                    <i class="fas fa-info-circle"></i> View Movie Details
                                                                </a>
                                                                <a href="{{ route('movie.edit', $order->movie->id) }}"
                                                ...
                                                @else
                                                    <div class="alert alert-warning">
                                                        <i class="fas fa-exclamation-triangle mr-2"></i> Movie information
                                                        not available
                                                    </div>
                                                @endif
                                            </div>
