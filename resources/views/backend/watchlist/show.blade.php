                    ...
                    <div class="col-12">
                        <div class="card">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Release Date</th>
                                                        <td>{{ $watchlist->movie->release_date ? $watchlist->movie->release_date->format('F d, Y') : 'N/A' }}
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-danger delete-btn" data-id="{{ $watchlist->id }}"
                                    data-url="{{ route('watchlist.destroy', $watchlist->id) }}">
                                    <i class="fas fa-trash"></i> Delete Watchlist
                                </button>
                            </div>
                        </div>
                        <!-- /.card -->
