                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Create New Subscription Plan</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter plan name" value="{{ old('name') }}">
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Enter slug or leave empty to auto-generate" value="{{ old('slug') }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Enter plan description">{{ old('description') }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" min="0" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Enter price" value="{{ old('price') }}">
                                            </div>
                                            @error('price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('billing_cycle') is-invalid @enderror" id="billing_cycle" name="billing_cycle">
                                                ...
                                                <option value="biannually" {{ old('billing_cycle') == 'biannually' ? 'selected' : '' }}>Biannually</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="1" class="form-control @error('duration_in_days') is-invalid @enderror" id="duration_in_days" name="duration_in_days" placeholder="Enter duration in days" value="{{ old('duration_in_days') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('features') is-invalid @enderror" id="features" name="features" rows="6" placeholder="Enter features, one per line">{{ old('features') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="has_trial" name="has_trial" value="1" {{ old('has_trial') ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="has_trial">Enable Free Trial</label>
                                            </div>
                                        </div>

                                        <div class="form-group" id="trial_days_group" style="{{ old('has_trial') ? '' : 'display: none;' }}">
                                            <label for="trial_days">Trial Period (days)</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="far fa-clock"></i></span>
                                                </div>
                                                <input type="number" min="1" class="form-control @error('trial_days') is-invalid @enderror" id="trial_days" name="trial_days" placeholder="Enter trial period in days" value="{{ old('trial_days', 7) }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">days</span>
                                                </div>
                                            </div>
