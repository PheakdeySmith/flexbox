...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-users mr-2"></i>Directors</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-list mr-2"></i>Director List</h3>
                            <div class="card-tools">
                                <a href="{{ route('director.create') }}" class="btn btn-primary btn-sm">
                                    <i class="fas fa-plus-circle mr-1"></i> Add New Director
                                </a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="mb-3">
                                <form action="{{ route('director.index') }}" method="GET" class="form-inline">
                                    <div class="input-group">
                                        <input type="text" name="search" class="form-control" placeholder="Search directors..." value="{{ request('search') }}">
                                    ...
                                    <tbody>
                                        @forelse($directors ?? [] as $director)
                                            <tr>
                                                ...
                                                <td>{{ Str::limit($director->biography ?? 'No biography available', 100) }}</td>
                                                ...
                                                <td>{{ $director->birth_date ? $director->birth_date->format('M d, Y') : 'N/A' }}</td>
                                                <td class="text-center">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="7" class="text-center">No directors found.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
