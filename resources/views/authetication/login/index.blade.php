...
<div class="user-login-card bg-body">
    ...
    <form action="https://templates.iqonic.design/streamit-dist/frontend/html/post">
      ...
      <div class="text-end mb-3">
        <a href="https://templates.iqonic.design/streamit-dist/frontend/html/reset-password.html"
          class="text-primary fw-semibold fst-italic">Forgot
          Password?</a>
      </div>
      <label class="list-group-item d-flex align-items-center mb-3 font-size-14 text-white fw-500"><input
          class="form-check-input m-0 me-2" type="checkbox">Remember Me</label>
      <div class="full-button">
        <div class="iq-button">
          <a href="https://templates.iqonic.design/streamit-dist/frontend/html/login.html#"
    ...
    <p class="my-4 text-center fw-500 text-white">New to Streamit? <a
    ...
    <ul class="p-0 pt-4 m-0 list-unstyled widget_social_media text-center">
      <li>
        <a href="https://templates.iqonic.design/www.google.com/" class="position-relative">
      ...
      <li>
        <a href="https://templates.iqonic.design/facebook.com/" class="position-relative">
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
            <path
              ...
              fill="url(#paint0_linear_770_72)"></path>
            <path
              ...
              fill="white"></path>
            <defs>
              <lineargradient id="paint0_linear_770_72" x1="5.41271" y1="5.41296" x2="21.9996" y2="21.9999"
      ...
      <li>
        <a href="https://templates.iqonic.design/twitter.com/" class="position-relative">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
