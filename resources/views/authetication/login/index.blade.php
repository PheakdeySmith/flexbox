...
@section('content')
    <div class="col-lg-5 col-md-12 align-self-center">
        <div class="user-login-card bg-body">
            <div class="text-center">
                ...
                <div class="logo-default">
                    <a class="navbar-brand text-primary"
                        ...
                        <img class="img-fluid logo" src="{{ asset('frontend/assets') }}/images/logo.webp" loading="lazy"
                            alt="streamit">
                    </a>
                </div>
            ...
            <p class="my-4 text-center fw-500 text-white">New to Streamit? <a href="{{ route('frontend.register') }}"
                    ...
                    <a href="https://templates.iqonic.design/facebook.com/" class="position-relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26"
                            ...
                            <path
                                ...
                                fill="white"></path>
                            <defs>
                                <lineargradient id="paint0_linear_770_72" x1="5.41271" y1="5.41296" x2="21.9996"
                                    y2="21.9999" gradientUnits="userSpaceOnUse">
